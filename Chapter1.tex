...
One of the most basic open questions in physics today concerns the nature of dark matter. While there has been strong observational evidence that non-luminous, gravitationally interacting matter exists \cite{rubin80},\cite{zwicky37} and makes up 23$\%$ of our universe \cite{planck14}, to date we know little more than the fact that this dark matter is most likely a stable, neutral particle that is non-relativistic and non-baryonic [NEEDSREF]\footnote{although dark matter could be caused by modifications to gravity}. There are several strongly motivated candidates for dark matter; the three most promising today are sterile neutrinos \cite{kusenko09}, Weakly Interacting Massive Particles (WIMPs) [NEEDSREF], and axions. 
